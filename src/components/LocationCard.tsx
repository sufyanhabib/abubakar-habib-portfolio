...
export function LocationCard() {
  ...
  return (
    <motion.div 
      ...
      className="relative w-full overflow-hidden rounded-[2.5rem] bg-secondary/5 border border-border/50 shadow-2xl group"
    >
      <div className="flex flex-col lg:flex-row h-full min-h-[650px] lg:min-h-[550px]">
        {/* Left Panel: Identity & Info */}
        <div className="w-full lg:w-[45%] p-8 lg:p-12 flex flex-col justify-between bg-background/40 backdrop-blur-xl border-b lg:border-b-0 lg:border-r border-white/5 relative z-20">
          <div className="space-y-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20">
                <Radio className="h-3 w-3 text-primary animate-pulse" />
                <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-primary font-bold">Identity Node</span>
              </div>
            ...
            <div className="space-y-6">
              <div className="p-6 rounded-2xl bg-secondary/10 border border-white/5 space-y-5">
                <div className="flex items-center gap-4">
                  <div className="p-2.5 bg-primary/10 rounded-xl border border-primary/20">
                    <MapPin className="h-5 w-5 text-primary" />
                  </div>
                  <div>
                    <p className="text-[9px] font-mono uppercase tracking-widest text-primary/60 mb-1">Origin Node</p>
                    <p className="text-base font-bold tracking-tight">Bihar, India</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="p-2.5 bg-secondary/20 rounded-xl border border-white/5">
                    <Compass className="h-5 w-5 text-muted-foreground" />
                  </div>
                  <div>
                    <p className="text-[9px] font-mono uppercase tracking-widest text-muted-foreground mb-1">Coordinates</p>
                    <p className="text-sm font-mono text-foreground/80">25.0961° N, 85.3131° E</p>
                  </div>
                </div>
              </div>
          ...
          <div className="pt-8 flex items-center justify-between border-t border-white/5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-mono uppercase tracking-widest text-muted-foreground">System Status: Operational</span>
            </div>
        ...
        <div className="w-full lg:w-[55%] relative min-h-[400px] lg:min-h-full overflow-hidden z-10">
          ...
          <div className="absolute top-8 right-8 z-[1000] flex flex-col gap-3">
            <div className="p-4 bg-background/80 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl">
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                  <div className="h-2.5 w-2.5 rounded-full bg-primary shadow-[0_0_8px_rgba(var(--primary),0.5)]" />
                  <span className="text-[10px] font-mono uppercase tracking-widest font-bold">Origin: Bihar</span>
                </div>
                {userLocation && (
                  <div className="flex items-center gap-3">
                    <div className="h-2.5 w-2.5 rounded-full bg-muted-foreground" />
                    <span className="text-[10px] font-mono uppercase tracking-widest font-bold">Node: You</span>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="absolute bottom-8 left-8 z-[1000]">
            <div className="px-5 py-2.5 bg-background/80 backdrop-blur-md border border-white/10 rounded-full shadow-2xl flex items-center gap-3 group/mesh">
              <Globe className="h-3.5 w-3.5 text-primary group-hover:rotate-90 transition-transform duration-700" />
              <span className="text-[10px] font-mono uppercase tracking-[0.3em] font-bold">Real-time Network Mesh</span>
            </div>
          </div>
        </div>
      </div>
